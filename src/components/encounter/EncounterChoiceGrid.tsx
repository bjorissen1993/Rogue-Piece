...
/**
 * Encounter choices render as a vertical list on all viewports.
 * On mobile, CSS accordion keeps collapsed rows title-only; the selected row expands.
 * (Do not reintroduce a mobile choice carousel here — that belongs only to crewmate pickers.)
 */
