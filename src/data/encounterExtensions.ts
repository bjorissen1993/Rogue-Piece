...
export const EXTENDED_ENCOUNTERS: Encounter[] = [
  ...
  },
  {
    ...
    description: "A smith's hammer rings over the harbor. Blades and spears line the wall — not free, but fair.",
    weight: 9,
    choices: [
      {
        id: "spear",
        text: "Buy an iron spear (฿180)",
        conditions: [{ type: "MIN_BERRIES", value: 180 }],
        outcome: {
          text: "You pay and take the iron spear. It goes into your pack — equip it when ready.",
          berriesChange: -180,
          grantWeaponId: "iron_spear",
        },
      },
      {
        id: "club",
        text: "Buy a wooden club (฿80)",
        conditions: [{ type: "MIN_BERRIES", value: 80 }],
        outcome: {
          text: "You pay for the wooden club. It sits in your backpack until you equip it.",
          berriesChange: -80,
          grantWeaponId: "wooden_club",
        },
      },
      { id: "leave", text: "Move on", outcome: { text: "Your purse stays heavy. Your hands stay empty." } },
    ],
  },
  {
    id: "sword_trainer",
    ...
    choices: [
      {
        ...
        outcome: {
          text: "You push until your arms shake.",
          trainStat: "strength",
        },
      },
      {
        ...
        outcome: {
          text: "Sand burns underfoot. Your pace sharpens.",
          trainStat: "speed",
        },
      },
      {
        ...
        outcome: {
          text: "You take hits on purpose until your stance settles.",
          trainStat: "defense",
        },
      },
      {
