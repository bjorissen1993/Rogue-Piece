...
export const EXTENDED_ENCOUNTERS: Encounter[] = [
    ...
    choices: [
      {
        ...
        text: "Leave the shop",
        outcome: {
          text: "You step back into the street, purse and pack unchanged.",
          goToEncounter: "island_hub",
        },
      },
    ],
  },
      ...
      },
      {
        ...
        outcome: {
          skillCheck: {
            ...
            failure: { text: "Waves hammer the hull.", hpChange: -14, shipRepair: -16 },
          },
  ...
  {
    id: "calm_fishing_grounds",
    title: "Calm Fishing Grounds",
    category: "SEA",
    tier: "EARLY",
    visual: { overlay: "SEA", background: "/backgrounds/sea.png" },
    description: "Birds wheel over silver water. Nets or patience could feed the crew.",
    weight: 9,
    ...
    choices: [
      {
        ...
        timeCost: "SLOT",
        outcome: {
          text: "The catch is honest work.",
          randomTable: [
            { weight: 50, outcome: { text: "Cooked fish for the night.", grantItemIds: ["cooked_fish"], hpChange: 8 } },
            { weight: 30, outcome: { text: "Extra dried strips for the hold.", grantItemIds: ["dried_meat"] } },
            { weight: 20, outcome: { text: "Empty nets and sore shoulders.", berriesChange: 10 } },
          ],
        },
      },
      {
        ...
        text: "Press on",
        timeCost: "BRIEF",
        outcome: { text: "You leave the grounds to the birds." },
      },
    ],
  },
  {
    ...
    description: "Three fat merchant hulls keep formation. Their escort watches your sail.",
    weight: 8,
    regions: ["EAST_BLUE", "SOUTH_BLUE", "WEST_BLUE", "NORTH_BLUE", "GRAND_LINE"],
    choices: [
      {
        id: "trade",
        text: "Signal for trade",
        timeCost: "SLOT",
        outcome: {
          text: "A longboat bumps your rail with careful smiles.",
          randomTable: [
            {
              weight: 40,
              outcome: {
                text: "You buy travel rations at a convoy rate.",
                berriesChange: -40,
            ...
            },
            {
              weight: 35,
              outcome: {
                text: "They buy a rumor and spare coin.",
                berriesChange: 60,
              },
            },
            {
              weight: 25,
              outcome: { text: "The escort waves you off before deals close." },
            },
          ],
        },
      },
      {
        id: "shadow",
        text: "Shadow at a distance",
        timeCost: "SLOT",
        outcome: {
          text: "You learn their heading — and they learn yours.",
          grantExperience: 6,
        },
      },
      {
        ...
        text: "Alter course",
        timeCost: "BRIEF",
        outcome: { text: "Wake crosses wake and vanishes." },
      },
    ],
  },
  // --- Island State hub + facilities (primary shore navigation) ---
  {
    id: "island_hub",
    title: "Island Hub",
    category: "RECOVERY",
    ...
    visual: { overlay: "LIGHT", background: "/backgrounds/village.png" },
    description:
      "You stand in the heart of the island. Choose where to go — harbor, inn, market, training, or the task board.",
    weight: 0,
    regions: ["EAST_BLUE", "SOUTH_BLUE", "WEST_BLUE", "NORTH_BLUE", "GRAND_LINE"],
    choices: [
      {
        ...
        text: "Harbor",
        timeCost: "BRIEF",
        flavour: "Ship, crew, cargo, and departure.",
        visual: { icon: "explore" },
        outcome: {
          text: "You walk down to the docks.",
          goToEncounter: "island_harbor",
        },
      },
      {
        id: "inn",
        text: "Inn",
        timeCost: "BRIEF",
        flavour: "Eat, drink, rest, and talk.",
        visual: { icon: "rest" },
        outcome: {
          text: "Warm light spills from the inn doorway.",
          goToEncounter: "island_inn",
        },
      },
      {
        id: "market",
        text: "Market",
        timeCost: "BRIEF",
        flavour: "Portable supplies for the road.",
        visual: { icon: "treasure" },
        outcome: {
          text: "Stalls and shop bells line the square.",
          goToEncounter: "general_store",
        },
      },
      {
        id: "training",
        ...
        timeCost: "BRIEF",
        flavour: "Posts, sand, and sweat.",
        visual: { icon: "gain_strength", variant: "train" },
        outcome: {
          text: "You find the yard behind the warehouses.",
      ...
      },
      {
        ...
        text: "Task Board",
        timeCost: "BRIEF",
        flavour: "Work, rumors, and paid trouble.",
        visual: { icon: "search" },
        outcome: {
          text: "Notices flutter on a weathered board.",
          goToEncounter: "island_task_board",
        },
      },
      {
        id: "weapon_shop",
        text: "Weapon Shop",
        timeCost: "BRIEF",
        flavour: "Steel, wood, and named blades.",
        conditions: [{ type: "HAS_FACILITY", facilityId: "WEAPON_SHOP" }],
        visual: { icon: "fight" },
        outcome: {
          text: "The smithy door is open.",
          goToEncounter: "weapon_smith",
        },
      },
      {
        id: "clinic",
        text: "Clinic",
        timeCost: "BRIEF",
        flavour: "Medicine and stern advice.",
        conditions: [{ type: "HAS_FACILITY", facilityId: "CLINIC" }],
        visual: { icon: "help" },
        outcome: {
          text: "Antiseptic bites the air.",
          goToEncounter: "clinic_shop",
        },
      },
      {
        id: "shipyard",
        text: "Shipyard",
        timeCost: "BRIEF",
        conditions: [{ type: "HAS_FACILITY", facilityId: "SHIPYARD" }],
        outcome: {
          text: "Timber and tar mark the yard.",
          goToEncounter: "island_shipyard",
        },
      },
      {
        id: "black_market",
        text: "Black Market",
        timeCost: "BRIEF",
        conditions: [{ type: "HAS_FACILITY", facilityId: "BLACK_MARKET" }],
        outcome: {
          text: "A side alley that should not exist.",
          goToEncounter: "island_black_market",
        },
      },
      {
        id: "library",
        text: "Library",
        timeCost: "BRIEF",
        conditions: [{ type: "HAS_FACILITY", facilityId: "LIBRARY" }],
        outcome: {
          text: "Quiet shelves wait beyond a narrow door.",
          goToEncounter: "island_library",
        },
      },
      {
        id: "marine_base",
        text: "Marine Base",
        timeCost: "BRIEF",
        conditions: [{ type: "HAS_FACILITY", facilityId: "MARINE_BASE" }],
        outcome: {
          text: "White banners snap over the compound.",
          goToEncounter: "island_marine_base",
        },
      },
      {
        id: "auction",
        text: "Auction House",
        timeCost: "BRIEF",
        conditions: [{ type: "HAS_FACILITY", facilityId: "AUCTION_HOUSE" }],
        outcome: {
          text: "A gavel waits for higher bids.",
          goToEncounter: "island_auction_house",
        },
      },
      {
        id: "explore",
        ...
        timeCost: "LONG",
        flavour: "Risk and reward beyond the main streets.",
        visual: { icon: "explore" },
        outcome: {
          text: "You push past the known streets.",
          randomTable: [
            {
              weight: 28,
            ...
            {
              weight: 20,
              outcome: { text: "A quiet spring. You wash and breathe.", hpChange: 18, adjustIslandTrust: 1 },
            },
            {
              weight: 16,
              outcome: { text: "Locals share a rumor and a few berries.", berriesChange: 35, adjustIslandTrust: 2 },
            },
            {
              weight: 12,
              outcome: { text: "Thorns and a bad step. Nothing fatal.", hpChange: -10 },
            },
            {
              weight: 12,
              outcome: {
                text: "You stumble into a street brawl that needs settling.",
                seekRandomEncounter: true,
                adjustIslandPressure: 6,
              },
            },
            {
              weight: 8,
              outcome: {
                text: "You help haul a broken cart — grateful nods follow.",
                berriesChange: 20,
                adjustIslandTrust: 4,
                adjustIslandPressure: -2,
              },
            },
            {
              weight: 8,
              outcome: {
                text: "A weathered notice mentions work inland — you mark the spot on your map.",
                berriesChange: 15,
                addIslandDiscoveryFlags: ["map_quest"],
              },
            },
            {
              weight: 6,
              outcome: {
                text: "Something odd stirs beyond the treeline. You fix the place in memory.",
                adjustIslandPressure: 3,
                addIslandDiscoveryFlags: ["map_event"],
              },
            },
            {
              weight: 4,
              outcome: {
                text: "A scrap of paper flutters from a torn notice board.",
                grantItemIds: ["wanted_poster_scrap"],
                grantKnowledgeCollectable: "wanted_poster_scrap",
              },
            },
          ],
        },
      ...
      {
        id: "map_quest",
        text: "Follow the quest",
        timeCost: "SLOT",
        flavour: "A quest you uncovered while exploring.",
        conditions: [{ type: "ISLAND_FLAG", flag: "map_quest" }],
        visual: { icon: "search" },
        outcome: {
          text: "You track down the quest from your map.",
          goToEncounter: "island_task_board",
        },
      },
      {
        id: "map_event",
        text: "Investigate the event",
        timeCost: "LONG",
        flavour: "An event you marked while exploring.",
        conditions: [{ type: "ISLAND_FLAG", flag: "map_event" }],
        visual: { icon: "explore" },
        outcome: {
          text: "You return to the marked event.",
          seekRandomEncounter: true,
          adjustIslandPressure: 4,
        },
      },
      {
        id: "tense_streets",
        text: "Investigate the tension",
        timeCost: "SLOT",
        flavour: "Pressure hangs thick — someone will snap.",
        conditions: [{ type: "MIN_ISLAND_PRESSURE", value: 45 }],
        visual: { icon: "search" },
        outcome: {
          text: "You follow raised voices into the alleys.",
          goToEncounter: "island_pressure_crackdown",
        },
      },
      {
        id: "quiet_bargain",
        text: "Seek a quiet bargain",
        timeCost: "SLOT",
        flavour: "High pressure, enough trust — someone wants a deal.",
        conditions: [
          { type: "MIN_ISLAND_PRESSURE", value: 55 },
          { type: "MIN_ISLAND_TRUST", value: 40 },
        ],
        outcome: {
          text: "A contact waves you into a shuttered storefront.",
          goToEncounter: "island_pressure_bargain",
        },
      },
      {
        id: "fund_harbor",
        text: "Fund harbor lights (฿220)",
        timeCost: "SLOT",
        conditions: [{ type: "MIN_BERRIES", value: 220 }],
        outcome: {
          text: "Coin goes toward lanterns along the pier.",
          fundIslandProject: "harbor_lights",
        },
      },
      {
        id: "accept_protection",
        text: "Accept local protection",
        timeCost: "SLOT",
        conditions: [{ type: "RUN_FLAG", flag: "island_protection_offer" }],
        outcome: {
          text: "You clasp rough hands over a dockside barrel.",
          acceptIslandProtection: true,
        },
      },
    ],
  },
  {
    ...
    category: "RECOVERY",
    tier: "EARLY",
    visual: { overlay: "LIGHT", background: "/backgrounds/beach.png" },
    description:
      "Your ship rides at the pier. Manage crew and cargo from the dock, or chart a course to another island.",
    weight: 0,
    regions: ["EAST_BLUE", "SOUTH_BLUE", "WEST_BLUE", "NORTH_BLUE", "GRAND_LINE"],
    choices: [
      {
        ...
        outcome: {
          text: "You leave the docks behind.",
          goToEncounter: "island_hub",
        },
      },
    ],
  },
  {
    ...
    tier: "EARLY",
    visual: { overlay: "SEA", background: "/backgrounds/sea.png" },
    description: "Sails full. The crossing continues until landfall or trouble finds you.",
    weight: 0,
    regions: ["EAST_BLUE", "SOUTH_BLUE", "WEST_BLUE", "NORTH_BLUE", "GRAND_LINE"],
    choices: [],
  },
  {
    id: "island_task_board",
    title: "Task Board",
    category: "SOCIAL",
    tier: "EARLY",
    visual: { overlay: "LIGHT", background: "/backgrounds/village.png" },
    description: "Notices, bounties, and odd jobs. Coin and trouble in equal measure.",
    weight: 0,
    regions: ["EAST_BLUE", "SOUTH_BLUE", "WEST_BLUE", "NORTH_BLUE", "GRAND_LINE"],
    choices: [
      {
        ...
        presentation: { primaryLabel: "LEAVE" },
        outcome: {
          text: "The board flutters in the wind behind you.",
          goToEncounter: "island_hub",
        },
      },
    ],
  },
  {
    ...
    tier: "EARLY",
    visual: { overlay: "LIGHT", background: "/backgrounds/beach.png" },
    description: "Keels, spars, and fresh tar. Coin buys repairs and a little more speed.",
    weight: 0,
    choices: [
      {
        id: "repair",
        text: "Repair hull (฿120)",
        timeCost: "SLOT",
        conditions: [{ type: "MIN_BERRIES", value: 120 }],
        outcome: {
          text: "Carpenters patch planks and re-tar the seams.",
          berriesChange: -120,
          shipRepair: 35,
          adjustIslandTrust: 1,
        },
      ...
      {
        id: "upgrade_sails",
        text: "Upgrade sails (฿280)",
        timeCost: "LONG",
        conditions: [{ type: "MIN_BERRIES", value: 280 }],
        outcome: {
          text: "New canvas bites the wind cleaner.",
          berriesChange: -280,
          shipUpgradeSpeed: 0.2,
          adjustIslandDevelopment: 2,
        },
      },
      {
        id: "look",
        text: "Tour the slips",
        timeCost: "BRIEF",
        outcome: { text: "Workers nod toward open berths and priced work orders." },
      },
      {
        id: "leave",
        text: "Leave",
        timeCost: "BRIEF",
        outcome: { text: "You leave the yard.", goToEncounter: "island_hub" },
      },
    ],
  },
  {
    id: "island_black_market",
    title: "Black Market",
    category: "RECOVERY",
    tier: "EARLY",
    visual: { overlay: "DARK", background: "/backgrounds/city.png" },
    description: "Coin talks quieter here. Rare goods — and sharper risks.",
    weight: 0,
    choices: [
      {
        id: "leave",
        text: "Leave",
        timeCost: "BRIEF",
        outcome: { text: "You slip back to daylight.", goToEncounter: "island_hub" },
      },
    ],
  },
  {
    ...
    tier: "EARLY",
    visual: { overlay: "LIGHT", background: "/backgrounds/village.png" },
    description: "Charts, journals, and dusty patience. Study here or send a crewmate to read.",
    weight: 0,
    choices: [
      {
        id: "read",
        text: "Read for a while",
        timeCost: "LONG",
        outcome: {
          text: "You learn a little about local currents and old names.",
          grantExperience: 12,
          adjustIslandTrust: 1,
          adjustIslandDevelopment: 1,
        },
      },
      {
        id: "assign_reading",
        text: "Send a crewmate to study",
        timeCost: "BRIEF",
        requiresParticipant: true,
        flavour: "They will be unavailable for a few watches.",
        outcome: {
          text: "You leave them among the shelves with a reading list.",
          startAssignment: {
      ...
      },
      {
        ...
        text: "Leave",
        timeCost: "BRIEF",
        outcome: { text: "You close the book.", goToEncounter: "island_hub" },
      },
    ],
  },
  {
    id: "island_marine_base",
    title: "Marine Base",
    category: "SOCIAL",
    tier: "EARLY",
    visual: { overlay: "LIGHT", background: "/backgrounds/city.png" },
    description: "Uniforms, drills, and paperwork. Affiliation shapes what you can ask for.",
    weight: 0,
    choices: [
      {
        id: "observe",
        text: "Observe the drills",
        timeCost: "SLOT",
        outcome: {
          text: "Marines shout cadence. You take the measure of the garrison.",
          adjustIslandPressure: 1,
        },
      },
      {
        id: "report_in",
        text: "Report as a Marine",
        timeCost: "SLOT",
        conditions: [{ type: "PLAYER_AFFILIATION", factionId: "MARINES" }],
        outcome: {
          text: "An officer stamps a temporary berth and notes your cooperation.",
          generateFactionMission: {
            title: "Shore patrol assist",
            description: "Walk the docks with local Marines and deter trouble.",
            factionId: "MARINES",
          },
          adjustIslandTrust: 3,
          adjustIslandPressure: -4,
          factionChanges: [{ factionId: "MARINES", amount: 3, reason: "Reported in at base" }],
        },
      },
      {
        id: "bribe_quiet",
        text: "Pay for quiet passage (฿150)",
        timeCost: "BRIEF",
        conditions: [
          { type: "MIN_BERRIES", value: 150 },
          { type: "PLAYER_AFFILIATION", factionId: "MARINES", negate: true },
        ],
        outcome: {
          text: "A clerk looks the other way — for now.",
          berriesChange: -150,
          adjustIslandPressure: -8,
          adjustIslandTrust: -2,
          factionChanges: [{ factionId: "MARINES", amount: -2, reason: "Bribed the gate" }],
        },
      },
      {
        id: "leave",
        text: "Leave",
        timeCost: "BRIEF",
        outcome: { text: "You step past the gate.", goToEncounter: "island_hub" },
      },
    ],
  },
  {
    id: "island_auction_house",
    title: "Auction House",
    category: "SOCIAL",
    tier: "EARLY",
    visual: { overlay: "LIGHT", background: "/backgrounds/city.png" },
    description: "Lots under cloth. Place a bid — or watch NPCs drive the price.",
    weight: 0,
    choices: [
      {
        id: "leave",
        text: "Leave",
        timeCost: "BRIEF",
        outcome: { text: "The gavel fades behind you.", goToEncounter: "island_hub" },
      },
    ],
  },
  {
    id: "island_pressure_crackdown",
    title: "Street Crackdown",
    category: "COMBAT",
    tier: "EARLY",
    visual: { overlay: "DARK", background: "/backgrounds/city.png" },
    description:
      "Boots on cobble. Someone is making an example — and the island's pressure made room for it.",
    weight: 0,
    conditions: [{ type: "MIN_ISLAND_PRESSURE", value: 40 }],
    choices: [
      {
        id: "intervene",
        text: "Intervene",
        ...
        risk: "MODERATE",
        outcome: {
          text: "You step between the batons and the crowd.",
          randomTable: [
            {
              weight: 45,
              outcome: {
                text: "The crowd scatters. You take a few hits but buy peace.",
                hpChange: -12,
                adjustIslandPressure: -12,
                adjustIslandTrust: 6,
                grantExperience: 15,
              },
            },
            {
              weight: 35,
              outcome: {
                text: "Blades come out — this will not stay a warning.",
                seekRandomEncounter: true,
                adjustIslandPressure: 4,
              },
            },
            {
              weight: 20,
              outcome: {
                text: "You talk a junior officer down with borrowed Marine jargon.",
                grantItemIds: ["marine_field_manual"],
                grantKnowledgeCollectable: "marine_field_manual",
                adjustIslandPressure: -8,
                adjustIslandTrust: 3,
                grantExperience: 12,
              },
      ...
      },
      {
        ...
        timeCost: "BRIEF",
        outcome: {
          text: "You keep your head down. The shouting fades behind you.",
          adjustIslandPressure: 2,
          goToEncounter: "island_hub",
        },
      },
      {
        ...
        conditions: [{ type: "PLAYER_AFFILIATION", factionId: "MARINES" }],
        outcome: {
          text: "You flash credentials and help clear the street.",
          adjustIslandPressure: -6,
          factionChanges: [{ factionId: "MARINES", amount: 4, reason: "Helped a shore crackdown" }],
          adjustIslandTrust: -3,
          grantExperience: 10,
          goToEncounter: "island_hub",
        },
  ...
  {
    id: "island_pressure_bargain",
    title: "Shuttered Bargain",
    category: "SOCIAL",
    tier: "EARLY",
    visual: { overlay: "DARK", background: "/backgrounds/city.png" },
    description: "A trusted contact offers rare goods while the island sweats under pressure.",
    weight: 0,
    conditions: [
      { type: "MIN_ISLAND_PRESSURE", value: 50 },
      { type: "MIN_ISLAND_TRUST", value: 35 },
    ],
    choices: [
      {
        id: "buy_charm",
        text: "Buy the coral charm (฿110)",
        timeCost: "BRIEF",
        conditions: [{ type: "MIN_BERRIES", value: 110 }],
        outcome: {
          text: "The charm sits warm in your palm — a door into fish-man talk.",
          berriesChange: -110,
          grantItemIds: ["coral_charm"],
          grantKnowledgeCollectable: "coral_charm",
          adjustIslandTrust: 2,
        },
      },
      {
        id: "buy_ledger",
        text: "Buy the old ledger (฿160)",
        timeCost: "BRIEF",
        conditions: [{ type: "MIN_BERRIES", value: 160 }],
        outcome: {
          text: "Ink and crossed-out names — hunter networks on paper.",
          berriesChange: -160,
          grantItemIds: ["old_bounty_ledger"],
          grantKnowledgeCollectable: "old_bounty_ledger",
          adjustIslandPressure: 3,
        },
      },
      {
        ...
        timeCost: "BRIEF",
        outcome: {
          text: "The shutters close. Maybe another night.",
          goToEncounter: "island_hub",
        },
      },
    ],
  },
  // --- Early survival: legacy shore day (weight 0 — hub replaces as primary nav) ---
  {
    id: "island_shore_day",
    title: "A Day Ashore",
    category: "RECOVERY",
    ...
    choices: [
      ...
      },
      {
        ...
        presentation: { primaryLabel: "LEAVE" },
        outcome: {
          text: "You head back to the known streets.",
          goToEncounter: "island_hub",
        },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        id: "assign_drills",
        text: "Schedule multi-watch drills",
        timeCost: "BRIEF",
        requiresParticipant: true,
        flavour: "They train away from the group for several watches.",
        outcome: {
          text: "You leave them with a drill plan and a water keg.",
          startAssignment: {
            type: "TRAINING",
            label: "Grounds drills",
            durationSlots: 4,
            focus: "strength",
          },
          adjustIslandTrust: 1,
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: "leave",
        text: "Move on",
        outcome: { text: "You leave the scrap heap to the gulls.", goToEncounter: "island_hub" },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      { id: "leave", text: "Leave", outcome: { text: "You walk away hungry but solvent.", goToEncounter: "island_hub" } },
    ],
  },
  {
    id: "general_store",
    ...
    choices: [
      ...
      },
      {
        ...
        conditions: [{ type: "MIN_BERRIES", value: 25 }],
        outcome: {
          text: "Warm rice for the road.",
          berriesChange: -25,
          grantItemIds: ["rice_ball"],
        },
      },
      { id: "leave", text: "Leave", timeCost: "BRIEF", outcome: { text: "The bell over the door jingles behind you.", goToEncounter: "island_hub" } },
    ],
  },
  {
    id: "clinic_shop",
    ...
    choices: [
      ...
      },
      {
        ...
        flavour: "Heal and clear toxins.",
        outcome: {
          text: "The nurse cleans, wraps, and sends you out upright.",
          berriesChange: -80,
          hpChange: 28,
          clearAfflictions: true,
          adjustIslandTrust: 2,
        },
      },
      {
        id: "bed_rest",
        text: "Book a recovery bed (฿150)",
        timeCost: "BRIEF",
        requiresParticipant: true,
        conditions: [{ type: "MIN_BERRIES", value: 150 }],
        flavour: "Hospitalize a wounded crewmate for proper care.",
        outcome: {
          text: "They are settled into a clinic bed under a stern nurse.",
          berriesChange: -150,
          startAssignment: {
            type: "HOSPITALIZED",
      ...
      {
        id: "fund_wing",
        text: "Fund a clinic wing (฿180)",
        timeCost: "SLOT",
        conditions: [{ type: "MIN_BERRIES", value: 180 }],
        outcome: {
          text: "Coin becomes clean linen and a second cot.",
          fundIslandProject: "clinic_wing",
        },
      },
      { id: "leave", text: "Leave", timeCost: "BRIEF", outcome: { text: "You keep your coin and your bruises.", goToEncounter: "island_hub" } },
    ],
  },
  {
    id: "island_inn",
    ...
    tier: "EARLY",
    visual: { overlay: "LIGHT", background: "/backgrounds/village.png" },
    description: "Beds upstairs, stew downstairs. Coin buys comfort — meals here are eaten, not packed.",
    weight: 0,
    regions: ["EAST_BLUE"],
    choices: [
      {
      ...
      },
      {
        ...
        conditions: [{ type: "MIN_BERRIES", value: 35 }],
        outcome: {
          text: "Warmth in a tin cup. The night softens a little.",
          berriesChange: -35,
          hpChange: 6,
        },
      },
      ...
      { id: "leave", text: "Leave", outcome: { text: "You step back into the street.", goToEncounter: "island_hub" } },
    ],
  },
  {
    id: "chase_the_thief",
    ...
    choices: [
      ...
      },
      {
        ...
        text: "Let them go",
        timeCost: "BRIEF",
        outcome: { text: "The pouch — and the thief — are gone.", goToEncounter: "island_hub" },
      },
    ],
  },
  {
